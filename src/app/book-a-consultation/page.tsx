...
export default function ContactUs() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await addDoc(collection(db, "book-a-consultation"), { dataToSave, created: new Date() });
            setForm({
                name: "",
                email: "",
                phone: "",
    ...
    return (
        <div
            id="contactUs"
            className="min-h-screen mt-10 flex items-center justify-center bg-gradient-to-b from-mai via-[#d6eaff] to-[#ffffff] px-2 py-10"
        >
            <div className="w-full max-w-6xl rounded-2xl bg-gradient-to-b from-[#ffffff] to-[#ffffff84] relative md:p-8 overflow-hidden">
                ...
                >
                    ...
                    <div className="flex-1 flex flex-col gap-3 justify-center">
                        <h2 className="text-lg sm:text-2xl md:text-4xl font-bold text-gray-700 mb-2 ">
                            {/* GET IN TOUCH */}
                            BOOK A CONSULTATION
                        </h2>
                        <div>
                        ...
                        <div className="!w-full border-b text-gray-700 border-gray-300">
                            <DatePicker
                                selected={selectedDate}
                                onChange={(date: Date | null) => setSelectedDate(date)}
                                placeholderText="Select a date"
                                className="w-full text-gray-700 bg-transparent px-1 py-2 text-base sm:text-lg focus:outline-none focus:border-black transition"
